...
Selected via SUPERMEM_LLM_PROVIDER env var:
...
def get_client_for_provider(provider: str) -> BaseModelClient:
    ...
    if cls is None:
        raise ProviderNotConfiguredError(
            f"Unknown SUPERMEM_LLM_PROVIDER='{provider}'. "
...
class OpenRouterClient(BaseModelClient):
    ...
    def __init__(self) -> None:
        ...
        self._default_model = SUPERMEM_LLM_MODEL or OPENROUTER_DEFAULT_MODEL
...
class VLLMClient(BaseModelClient):
    ...
    def __init__(self) -> None:
        ...
        self._default_model = SUPERMEM_LLM_MODEL or VLLM_DEFAULT_MODEL
...
class ClaudeClient(BaseModelClient):
    ...
    def __init__(self) -> None:
        ...
        self._default_model = SUPERMEM_LLM_MODEL or ANTHROPIC_DEFAULT_MODEL
...
class LMStudioClient(BaseModelClient):
    ...
    def __init__(self) -> None:
        ...
        self._default_model = SUPERMEM_LLM_MODEL or LMSTUDIO_DEFAULT_MODEL
